...
class AppStrings {
  ...
  static const Map<String, String> _tr = {
    ...
    'progress.emptySubtitle': 'Sistemde kayıtlı ilerleme raporu yok.',
    ...
    'settings.adminDesc': 'Üyeler, istatistikler ve yönetim',
  ...
  static const Map<String, String> _en = {
    ...
    'progress.emptySubtitle': 'No progress reports in the system yet.',
    ...
    'settings.adminDesc': 'Members, stats and management',
